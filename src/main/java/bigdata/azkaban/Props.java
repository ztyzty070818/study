...
//    }
	...
	public static void main(String[] args) throws IOException {
		Props props = new Props(null, "/home/qwe/Projects/test/src/main/java/bigdata/azkaban/test.properties");
		Props nonProps = new Props(null, "/home/qwe/Projects/test/src/main/java/bigdata/azkaban/test-non.properties");

		for(String key : nonProps.getKeySet()) {
			if(StringUtils.isBlank(nonProps.get(key)) ) {
				String value = props.get(key);
				if(StringUtils.isNotBlank(value)) {
					nonProps.put(key, value);
				}
			}
		}
