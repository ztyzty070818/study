...
//        dtDir("/test/test");
//        listAllFiles("/test");
//        download("hdfs://192.168.0.221/test/word_count", "tmp/bigdata.hadoop/test");
//        upload("/tmp/bigdata.hadoop/test/1234","hdfs://192.168.0.221/test/");
        getNodeMessage();
        getBlockLocations();
    }
    ...
    public static FileSystem getFileSystem() throws URISyntaxException, IOException {
        ...
        URI uri = new URI("hdfs://localhost");
